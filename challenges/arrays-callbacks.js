...
function getName() {
  const displayNames = [];
  zooAnimals.forEach((curentItem) => {
    displayNames.push(`Name: ${curentItem.animal_name}, Scientific: ${curentItem.scientific_name}.`);
...
function animalNames () {
  const lowCaseAnimalNames = zooAnimals.map((curentItem) => {
    return `${curentItem.animal_name.toLowerCase()}`;
  });
